        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <form action="" method="post">
              <table class="table table-hover table-bordered">
                ...
                <im>
                  <tr>
                    <?php
                    $query = "SELECT * FROM comments WHERE comment_post_id =" . mysqli_real_escape_string($connection, $_GET['pid']) . " ";
                    ...
                    <?php
                      ...
                      echo "<td><a href='./post_comments.php?delete={$comment_id}&pid=" . $_GET['pid'] . "'>Delete</a></td>";
                      echo "</tr>";
                    }
                    ?>
                  </tr>
            ...
            if (isset($_GET['approve'])) {
              ...
              header("Location: post_comments.php?pid=" . $_GET['pid']);
            }
